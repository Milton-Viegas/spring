...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder().title("DeLaVega Blog").description("Projeto API Spring - Blog Pessoal")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/Milton-Viegas")
				.contact(contact()).build();
	}

	private static Contact contact() {

		return new Contact("Milton Viegas", "https://github.com/Milton-Viegas", "milton.viegas.br@gmail.com");
